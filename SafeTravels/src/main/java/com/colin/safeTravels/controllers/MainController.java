package com.colin.safeTravels.controllers;
...
import com.colin.safeTravels.services.ExpenseService;
...
public class MainController {
    ...
    public String deleteExpense(@PathVariable("id") Long id) {
        expenseService.deleteExpense(expenseService.findExpense(id));
        return "redirect:/expenses";
    }
}
